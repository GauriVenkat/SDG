...
<body>
	...
	<?php
               ...
               // if (isset($_POST['update'])) {
                 echo '
                  ...
                  while ($course_row = mysqli_fetch_array($query_display)) {
                    ...
                    <td><input type='text' name='ia_update' value='".$course_row['IA']."'></td>
                    <td>".$course_row['TW']."</td>
	    ...
	    <input type="button" value="Logout" class="btn" onclick="window.location='http://localhost/SDG-RAIT/internal_login.php'"/>
